  ...
  <div class="container">
    ...
    <nav class="navbar navbar-light bg-white">
      <div class="container-fluid">
        ...
        <div>
          ...
          <a href="#" class="btn btn-success rounded-pill">Daftar Sekarang</a>
        </div>
      </div>
    </nav>
    ...
    <div class="row mb-5">
      ...
      >
        ...
        >
          <div class="card" style="max-width: 230px; height: 170px">
      ...
      <div class="d-flex justify-content-end">
        <button class="btn btn-success rounded-pill text-uppercase me-3">
          <span
            class="
              d-inline-block
              rounded-circle
        ...
        <button class="btn btn-success rounded-pill text-uppercase">
          Next
          <span
            class="
              d-inline-block
    ...
    <div class="row" style="margin-bottom: 160px">
      ...
      <div class="d-flex justify-content-center">
        <button class="btn btn-success rounded-pill">ALL Receipt</button>
      </div>
    </div>
